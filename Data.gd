...
const ITEM_LIST = {
	...
	"sword": { "name": "sword", "char": "/", "interact": false, "value": 2, "equip": "weapon", "effect": {"attack": 3} },
...
const ENEMY_LIST = {
	...
	"frog": { "name": "canetoad", "char": "F", "hp": 5, "attack": 2, "move_delay": 2, "move_range": 5, "notice_range": 14 },
}
